...
for ($i=0; $i < 20 ; $i++) { 
    ...
    array_push($array_return, array('id'=>$feeds_data_array[$i]['id'], 'created_at' => $date_created_at, 'text'=> $feeds_data_array[$i]['text'], 'name'=> $feeds_data_array[$i]['user']['name'], 'screen_name' => $feeds_data_array[$i]['user']['screen_name']));
