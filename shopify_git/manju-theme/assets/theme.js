...
theme.Sections = function Sections() {
  ...
  $(document)
    .on('shopify:section:load', alert("hello"), this._onSectionLoad.bind(this))
    .on('shopify:section:unload', alert("hello"),this._onSectionUnload.bind(this))
    .on('shopify:section:select', alert("hello"),this._onSelect.bind(this))
    .on('shopify:section:deselect', alert("hello"),this._onDeselect.bind(this))
    .on('shopify:block:select', alert("hello"),this._onBlockSelect.bind(this))
    .on('shopify:block:deselect', alert("hello"),this._onBlockDeselect.bind(this));
};
